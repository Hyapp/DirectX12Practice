...
void D3D12HelloTexture::LoadAssets()
{
    ...
    //Create pso
    {
        ...
        ThrowIfFailed(D3DCompileFromFile(L"Shader/TestTexture.hlsl", nullptr, nullptr, "main", "vs_5_0", compileFlags, 0, &vertexShader, nullptr));
        ThrowIfFailed(D3DCompileFromFile(L"Shader/TestTexture.hlsl", nullptr, nullptr, "PSMain", "ps_5_0", compileFlags, 0, &pixelShader, nullptr));
    ...
    //Close the cmd list and execute it to begin the initial GPU setup.
    ...
    // Create synchronization objects.
    {
        ...
        //Wait for the cmd list to execute. we are reusing the same command
        //list in main loop but for now, we just wait for setup to complete
        //before continuing.
