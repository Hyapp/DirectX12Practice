...
void BoxApp::BuildShadersAndInputLayout()
{
	...
	mvsByteCode = d3dUtil::CompileShader(L"shader/Box_C6.hlsl", nullptr, "main", "vs_5_0");
	mpsByteCode = d3dUtil::CompileShader(L"shader/Box_C6.hlsl", nullptr, "PSMain", "ps_5_0");
...
void BoxApp::BuildBoxGeometry()
{
	...
	mBoxGeo->IndexBufferGPU = d3dUtil::CreateDefaultBuffer(md3dDevice.Get(), mCommandList.Get(), indices.data(), vbByteSize, mBoxGeo->IndexBufferUploader);
